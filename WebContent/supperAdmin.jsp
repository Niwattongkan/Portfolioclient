...
<body class="fixed-nav sticky-footer bg-dark" id="page-top">
	...
	<nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top"
		id="mainNav">
		<a class="navbar-brand" href="index.jsp">Start manage</a>
			...
			<ul class="navbar-nav navbar-sidenav" id="exampleAccordion">
				...
				<li class="nav-item" data-toggle="tooltip" data-placement="right"
					title="Tables"><a class="nav-link" href="#"> <i
						class="fa fa-fw fa-table1"></i> <span class="nav-link-text">Teacher</span>
				</a></li>
				<li class="nav-item" data-toggle="tooltip" data-placement="right"
					title="Tables"><a class="nav-link" href="index.jsp"> <i
						class="fa fa-fw fa-table2"></i> <span class="nav-link-text">Back</span>
				</a></li>
	...
	<div class="content-wrapper">
		<div class="container-fluid">
			...
			<ol class="breadcrumb">
				...
				<li class="breadcrumb-item active">Tables teacher</li>
			</ol>
			<!-- Example DataTables Card-->
			<div class="card mb-3">
				<div class="card-header">
					<i class="fa fa-table"></i> Data Table teacher
				</div>
							...
							<thead>
								...
								<c:forEach items="${typeList}" var="user">
									<tr>
										...
										<td>${user.typeUser}</td>
										<a href="editUser.do?id=${user.userID}">Edit</a>
										<a href="deleteUser.do?id=${user.userID}">remove</a>
									</tr>
								</c:forEach>
						</table>
						<a href="newType.do">Add New User</a>	
					</div>
				</div>
